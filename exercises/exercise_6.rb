...
# Your code goes here ...
@store1.employees.create(first_name: 'Bubbilz', last_name: 'Connoryson', hourly_rate: 41)
...
@store2.employees.create(first_name: 'Jim', last_name: 'Flemmingwayson', hourly_rate: 45)
